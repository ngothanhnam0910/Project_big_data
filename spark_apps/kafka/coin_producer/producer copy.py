...
class CoinProducer:
    def __init__(self):
        log_handler = RotatingFileHandler(
            f"{os.path.abspath(os.getcwd())}/spark_apps/kafka/coin_producer/logs/producer.log",
    ...
    def run(self):
        with open(os.path.abspath(os.getcwd()) + "/spark_apps/kafka/coin_producer/symbol_list.csv") as f:
